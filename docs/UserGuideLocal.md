...
>   However, do be careful when giving `undo` commands when you have performed some non-`add, edit, delete` commands after the command you wish to `undo`, the results produced may be undesirable.
